...
export default class Chart extends React.Component {
     state = {
       ...
       async componentDidMount(){
        ...
        for (j in userLPs){
            if(userLPs[j].id = "0x154da9488291e7b682cf892e5b5471c20566f39b-0xd6169a40bbc913bb7c34e769261b3dd2315f20bb"){
                staked = staked+userLPs[j].pair.reserveUSD
            }
        }
        
        
        this.setState({totalValue :LPTrack[0].reserveUSD, staked:staked})
    }
            ...
            <div class="farm_box">
              ...
              <div class="farm_name">
                ...
                <div class="farm_name_box">
                  <h2 color="text" class="final_name">AVS-ETH LP</h2>
                  <div class="fees_box">
                    <div class="fees">
                ...
                <div class="sc-eCssSg info_row">
                    ...
                    <div color="text" class="sc-gsTCUz info_row_b">AVS-ETH LP</div>
                </div>
                <div class="sc-eCssSg info_row">
                    ...
                    <div class="sc-kIeTtH cnxSGb">
                        <div class="sc-eCssSg info_row">
                            <div color="text" class="sc-gsTCUz info_row_a">Deposit:</div>
                                <a target="_blank" rel="noreferrer noopener" href="https://exchange.sushiswapclassic.org/#/swap?inputCurrency=0x94d916873b22c9c1b53695f1c002f78537b9b3b2&outputCurrency=ETH" class="sc-gsTCUz sc-lmoMRL dCVmfN iqbrwR sc-hOqqkJ hShxNi" color="primary">AVS-ETH LP
                            ...
                            <div class="sc-eCssSg info_row">
                                ...
                                <div color="text" class="sc-gsTCUz info_row_a">${this.state.totalValue.toLocaleString()}</div>
                            </div><div class="sc-eCssSg info_row">
                            <div color="text" class="sc-gsTCUz info_row_a">My Staked Value:</div>
                            <div color="text" class="sc-gsTCUz info_row_a">${this.state.staked.toLocaleString()}</div>
                        </div>
                        <div class="sc-eCssSg FgqtZ">
                            <a target="_blank" rel="noreferrer noopener" href="https://etherscan.io/address/0xaab3cd27375bd8f46b2081a2ff6346f485e32f6d" color="primary" class="scan">View on Etherscan</a>
                        </div>
                    </div>
                </div>
            </div>
